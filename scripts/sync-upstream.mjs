#!/usr/bin/env node
/**
 * Merges upstream (yoopta-editor/Yoopta-Editor) into this fork, keeping the
...
if (!remotes.includes('upstream')) {
  ...
  console.error('  git remote add upstream https://github.com/yoopta-editor/Yoopta-Editor.git');
  process.exit(1);
}
